...
["display-as-functions"] = function(...) 
--[[ Generated with https://github.com/TypeScriptToLua/TypeScriptToLua ]]
local ____exports = {}
local customDisplayPropertyIndex = 0
local customDisplayName = "CustomDisplay2"
function ____exports.draw(property_values, display_info, dirty_rect)
...
function ____exports.recognizeGesture(property_values, display_info, gesture_start_point)
...
function ____exports.invalidate(property_values, last_property_values, display_info)
...
function ____exports.onTap(property_values, display_info, gesture_info, custom_data)
    local propertyValue = property_values[customDisplayPropertyIndex + 1]
...
function ____exports.onUpdate(property_values, display_info, gesture_info, custom_data)
    jbox.trace(customDisplayName .. ":onUpdate")
    return {}
end
function ____exports.onRelease(property_values, display_info, gesture_info, custom_data)
    jbox.trace(customDisplayName .. ":onRelease")
    return {}
end
function ____exports.onCancel(property_values, display_info, gesture_info, custom_data)
    jbox.trace(customDisplayName .. ":onCancel")
    return {}
end
return ____exports
 end,
["display-class-example"] = function(...) 
local ____lualib = require("lualib_bundle")
local __TS__Class = ____lualib.__TS__Class
local ____exports = {}
local customDisplayPropertyIndex = 0
____exports.CustomDisplayClassExample = __TS__Class()
local CustomDisplayClassExample = ____exports.CustomDisplayClassExample
CustomDisplayClassExample.name = "CustomDisplayClassExample"
function CustomDisplayClassExample.prototype.____constructor(self, customDisplayName)
    self.customDisplayName = customDisplayName
end
function CustomDisplayClassExample.prototype.draw(self, property_values, display_info, dirty_rect)
    local propertyValue = property_values[customDisplayPropertyIndex + 1]
    jbox.trace((self.customDisplayName .. ":draw: ") .. tostring(propertyValue))
    local color = propertyValue == 0 and ({r = 255, g = 0, b = 0}) or ({r = 0, g = 255, b = 50})
    local rect = {top = 2, left = 2, bottom = 20, right = 30}
    jbox_display.draw_rect(rect, color)
    jbox_display.draw_text(
...
function CustomDisplayClassExample.prototype.recognizeGesture(self, property_values, display_info, gesture_start_point)
    return {handlers = {on_tap = "onTap" .. self.customDisplayName, on_update = "onUpdate" .. self.customDisplayName, on_release = "onRelease" .. self.customDisplayName, on_cancel = "onCancel" .. self.customDisplayName}}
end
function CustomDisplayClassExample.prototype.invalidate(self, property_values, last_property_values, display_info)
    if display_info then
        local ____jbox_display_invalidate_4 = jbox_display.invalidate
        local ____display_info_width_0 = display_info
        if ____display_info_width_0 ~= nil then
...
function CustomDisplayClassExample.prototype.onTap(self, property_values, display_info, gesture_info, custom_data)
    local propertyValue = property_values[customDisplayPropertyIndex + 1]
    jbox.trace((self.customDisplayName .. ":onTap: ") .. tostring(propertyValue))
    return {
        property_changes = {propertyValue == 0 and 1 or 0},
        gesture_ui_name = jbox.ui_text("gesture_ui_name_" .. self.customDisplayName)
    }
end
function CustomDisplayClassExample.prototype.onUpdate(self, property_values, display_info, gesture_info, custom_data)
    jbox.trace(self.customDisplayName .. ":onUpdate")
    return {}
end
function CustomDisplayClassExample.prototype.onRelease(self, property_values, display_info, gesture_info, custom_data)
    jbox.trace(self.customDisplayName .. ":onRelease")
    return {}
end
function CustomDisplayClassExample.prototype.onCancel(self, property_values, display_info, gesture_info, custom_data)
    jbox.trace(self.customDisplayName .. ":onCancel")
    return {}
end
return ____exports
 end,
...
local ____exports = {}
local MyDisplay2 = require("display-as-functions")
local ____display_2Dclass_2Dexample = require("display-class-example")
local CustomDisplayClassExample = ____display_2Dclass_2Dexample.CustomDisplayClassExample
_G.format_version = "1.0"
_G.registerGlobal = function(self, customDisplay, name)
    _G["draw" .. name] = function(property_values, display_info, dirty_rect)
        customDisplay:draw(property_values, display_info, dirty_rect)
    end
    _G["invalidate" .. name] = function(property_values, last_property_values, display_info)
        customDisplay:invalidate(property_values, last_property_values, display_info)
    end
    _G["gesture" .. name] = function(property_values, display_info, gesture_start_point)
        return customDisplay:recognizeGesture(property_values, display_info, gesture_start_point)
    end
    _G["onTap" .. name] = function(property_values, display_info, gesture_info, custom_data)
        return customDisplay:onTap(property_values, display_info, gesture_info, custom_data)
    end
    _G["onUpdate" .. name] = function(property_values, display_info, gesture_info, custom_data)
        return customDisplay:onUpdate(property_values, display_info, gesture_info, custom_data)
    end
    _G["onRelease" .. name] = function(property_values, display_info, gesture_info, custom_data)
        return customDisplay:onRelease(property_values, display_info, gesture_info, custom_data)
    end
end
local name1a = "CustomDisplayClassExampleInstance1"
local customDisplay1a = __TS__New(CustomDisplayClassExample, name1a)
_G:registerGlobal(customDisplay1a, name1a)
local name1b = "CustomDisplayClassExampleInstance2"
local customDisplay1b = __TS__New(CustomDisplayClassExample, name1b)
_G:registerGlobal(customDisplay1b, name1b)
local name2 = "CustomDisplay2"
